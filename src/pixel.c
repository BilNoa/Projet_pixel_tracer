...
/**
 * @brief Trace un segment par l'algorithme de Bresenham.
 *
 * @param x, y  point de départ
 * @param dx, dy  déplacements signés (peuvent être négatifs)
 */
...
/**
 * @brief Trace un cercle par l'algorithme du point médian (Bresenham cercle).
 *
 * Génère les 8 octants en symétrie à partir du quart supérieur droit.
 */
...
/* rectangle : 4 segments via draw_segment */
...
/* carré : 4 segments de longueur égale */
...
/* polygone : segments consécutifs entre les sommets */
...
/**
 * @brief Calcule le point médian pondéré entre p1 et p2 au paramètre t ∈ [0,1].
 */
...
/**
 * @brief Algorithme de De Casteljau — calcule le point de la courbe de Bézier au paramètre t.
 *
 * @param points  tableau de pointeurs vers les points de contrôle
